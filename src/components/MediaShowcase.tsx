...
const MEDIA_PROJECTS = [
  {
    id: "proj-101",
    name: "Web Security Toolkit",
    status: "ACTIVE",
    description: "Automated evasion node utilizing custom browser tracking rotation and atomic clock-synced JS fingerprint spoofing. Designed to bypass high-end strict auth loops.",
    githubUrl: "https://github.com/all3n1k/web-security-suite",
    icon: AlertTriangle,
    videoSrc: "", 
  },
  {
    id: "proj-042",
    name: "Robotic TCP Controller",
    status: "FIRMWARE_MOD",
    description: "ESP8266 custom firmware bridge overriding stock app auth protocols to establish raw TCP binds, enabling precise PC-command executions tracking robotic movement constraints.",
    githubUrl: "https://github.com/all3n1k/spider-robot-controller",
    icon: Terminal,
    videoSrc: "",
  },
  {
    id: "proj-255",
    name: "AI Jewelry Pipeline",
    status: "ARCHIVED",
    description: "Production diffusion model generator directly hooked into a nodal web workspace. Employs fiber network hooks to deploy raw image assets down to manufacturing workstations.",
    githubUrl: "https://github.com/all3n1k/jewelry-ai-platform",
    icon: Code2,
    videoSrc: "", 
  }
];
